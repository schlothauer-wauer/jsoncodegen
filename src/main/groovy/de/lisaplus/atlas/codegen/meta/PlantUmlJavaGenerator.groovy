 ...
 */
class PlantUmlJavaGenerator extends SingleFileGenarator {
    private static final Logger log=LoggerFactory.getLogger(PlantUmlJavaGenerator.class)

    void initTemplate() {
        template = createTemplateFromResource('templates/meta/plantuml_java.txt',TemplateType.GString)
    }
